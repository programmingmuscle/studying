                    ...
                    <form action="complete.php" method="POST">
                        ...
                        <div class="container">
                            <div class="form-group row">
                                ...
                                <label class="col-form-label col-sm-3" display="inline-block">会社名：</label>
                        ...
                        <div class="container">
                                ...
                                <div class="  offset-sm-3p-0 m-0 text-center">
                                    <!-- 送信ボタンを緑色にする設定を追加 -->
                                    <!-- さらに、送信ボタンは、指定のカラム幅に対して100％の幅となる設定を追加 -->
                                    <button type="submit" class="btn btn-success w-100">お問い合わせ内容を送信する</button>
                                </div>
